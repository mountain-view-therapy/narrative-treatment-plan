                    ...
                    }
                    {
                        ...
                        <>
                            ...
                            {goal1.objectives.map((objective, index) =>
                                <>
                                    {!goal1.updatingGoal && replaceText(index + 1 + ") " + possibleObjectives[objective.possibleObjectiveIndex].title, [], goal1.issue)}
                                    <ul>
                                    ...
                                    {goal1.updatingGoal && objective.noProgressChecked && <p>{replaceText(index + 1 + ") " + possibleObjectives[index].options["No Progress"].text, [], goal1.issue)}</p>}
                                    {goal1.updatingGoal && objective.stillWorkingChecked &&
                                        <>
                                            {replaceText(index + 1 + ") " + possibleObjectives[index].options["Still Working"].text, [], goal1.issue)}
                                            <ul>
                                    ...
                                    {goal1.updatingGoal && objective.finishedChecked &&
                                        <>
                                            {replaceText(index + 1 + ") " + possibleObjectives[index].options["Finished"].text, [], goal1.issue)}
                                            <ul>
                    ...
                    }
                    {
                        ...
                        <>
                            ...
                            {goal2.objectives.map((objective, index) =>
                                <>
                                    {!goal2.updatingGoal && replaceText(index + 1 + ") " + possibleObjectives[objective.possibleObjectiveIndex].title, [], goal2.issue)}
                                    <ul>
                                    ...
                                    {goal2.updatingGoal && objective.noProgressChecked && <p>{replaceText(index + 1 + ") " + possibleObjectives[index].options["No Progress"].text, [], goal2.issue)}</p>}
                                    {goal2.updatingGoal && objective.stillWorkingChecked &&
                                        <>
                                            {replaceText(index + 1 + ") " + possibleObjectives[index].options["Still Working"].text, [], goal2.issue)}
                                            <ul>
                                    ...
                                    {goal2.updatingGoal && objective.finishedChecked &&
                                        <>
                                            {replaceText(index + 1 + ") " + possibleObjectives[index].options["Finished"].text, [], goal2.issue)}
                                            <ul>
                    ...
                    }
                    {
                        ...
                        <>
                            ...
                            {goal3.objectives.map((objective, index) =>
                                <>
                                    {!goal3.updatingGoal && replaceText(index + 1 + ") " + possibleObjectives[objective.possibleObjectiveIndex].title, [], goal3.issue)}
                                    <ul>
                                    ...
                                    {goal3.updatingGoal && objective.noProgressChecked && <p>{replaceText(index + 1 + ") " + possibleObjectives[index].options["No Progress"].text, [], goal3.issue)}</p>}
                                    ...
                                    {goal3.updatingGoal && objective.finishedChecked &&
                                        <>
                                            {replaceText(index + 1 + ") " + possibleObjectives[index].options["Finished"].text, [], goal3.issue)}
                                            <ul>
